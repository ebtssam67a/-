...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
        it(' has a URL defined N url is not empty', function() {
         ...
         */
        it(' has a name defined N name is not empty', function() {
            allFeeds.forEach(feed => {
    ...
    describe('The menu', function() {
        ...
        it('changes visibility when the menu icon is clicked',function(){
            ...
            let burgerIcon = $('.menu-icon-link');
            burgerIcon.click();
            //git the body class again
            let newBodyClass = document.body.className
            //compare the old class with the new 
            expect(newBodyClass).not.toBe(bodyClass);

            //clic again
            burgerIcon.click();
            expect(document.body.className).not.toBe(newBodyClass);
